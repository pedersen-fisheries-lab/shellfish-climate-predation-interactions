...
drive_download(as_id("1cEtE40u1oO6pQBlMNPYB4Z5L3l7EG4wV"),path="data/temp/Gulf_Diet_Data.csv",overwrite=TRUE)
drive_download(as_id("1NTK3_InPHkyuuNgO8XvokBznQYXyH4rq"),path="data/temp/Gulf_StrataInfo.csv",overwrite=TRUE)
drive_download(as_id("1nWfEw7GwOg9XG17f6zHshvIV9lB4rP45"),path="data/temp/Gulf_AbioticData.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Gulf_Diet_Data.csv')
Strata_info<-fread('data/temp/Gulf_StrataInfo.csv')
...
fwrite(Data, "data/diet/Gulf_Diet_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Gulf_Diet_Data.csv")
file.remove("data/temp/Gulf_StrataInfo.csv")
