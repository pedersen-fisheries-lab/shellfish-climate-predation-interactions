...
# Load crab data
Data<-fread("data/temp/alldata_allsources.csv")

# Load cleaned RV data
RV_Data<- fread("data/temp/Newfoundland_RV_Data_Cleaned.csv")
...
fwrite(Data, "data/temp/Newfoundland_RV_Data_Cleaned.csv")
