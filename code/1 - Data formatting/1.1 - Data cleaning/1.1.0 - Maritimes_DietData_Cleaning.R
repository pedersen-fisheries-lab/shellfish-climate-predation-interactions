...
drive_download(as_id("16w_I14HGWR41aDmfV1pxY1pCvAcoXsTr"),path="data/temp/Maritimes_DietData.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Maritimes_DietData.csv')
...
fwrite(Data, "data/diet/Maritimes_Diet_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Maritimes_DietData.csv")
