...
drive_download(as_id("1Ocnqh3uKnlSKHDachJL36aZRcwl-eGiZ"),path="data/temp/Gulf_RVDataFishGroup.csv",overwrite=TRUE)
drive_download(as_id("1QlT7M1jkIbhVFdUzygFbn8QO7KGWU0gc"),path="data/temp/Gulf_RVDataMainFish.csv",overwrite=TRUE)
drive_download(as_id("1IHvXXl9bTqp0hZsR6lqTjew7wHePfuJw"),path="data/temp/Gulf_RVDataCrab.csv",overwrite=TRUE)
drive_download(as_id("1Thgi_231jogCm-itU3EdG1pOBbhj_eCM"),path="data/temp/Gulf_RVDataShrimp.csv",overwrite=TRUE)

# Load data
Data_FishGroup<-fread('data/temp/Gulf_RVDataFishGroup.csv')
Data_MainFish<-fread('data/temp/Gulf_RVDataMainFish.csv')
Data_Crab<-fread('data/temp/Gulf_RVDataCrab.csv')
Data_Shrimp<-fread('data/temp/Gulf_RVDataShrimp.csv')
...
fwrite(Data, "data/RV_survey/Gulf_RV_Data_Cleaned.csv")

# Remove temporary files
file.remove("data/temp/Gulf_RVDataFishGroup.csv")
file.remove("data/temp/Gulf_RVDataMainFish.csv")
file.remove("data/temp/Gulf_RVDataCrab.csv")
file.remove("data/temp/Gulf_RVDataShrimp.csv")
