...
drive_download(as_id("1xHuVHU5YYW8ahggnZr0sIoQx4OkIxq0s"),path="data/temp/Maritimes_RVData.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Maritimes_RVData.csv')
...
file.remove("data/temp/Maritimes_RVData.csv")
