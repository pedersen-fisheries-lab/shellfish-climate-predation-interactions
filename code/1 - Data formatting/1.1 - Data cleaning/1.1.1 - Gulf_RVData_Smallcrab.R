...
drive_download(as_id("1cYa7PeSvQ3LtUY6Naueh43bV2HAxLDWO"),path="data/temp/gul_smallcrab_data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/gul_smallcrab_data.csv')

# Load cleaned RV data
RV_Data<- fread("data/temp/Gulf_RV_Data_Cleaned.csv")
...
fwrite(Data, "data/temp/Gulf_RV_Data_Cleaned.csv")
