...
drive_download(as_id("11PlbFVdYHbhIofejduKWg1gJTezTg8CD"),path="data/temp/Arctic_RV_Data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Arctic_RV_Data.csv')
...
fwrite(Data, "data/RV_survey/Arctic_RV_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Arctic_RV_Data.csv")
