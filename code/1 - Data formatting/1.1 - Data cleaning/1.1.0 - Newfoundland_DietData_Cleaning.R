...
drive_download(as_id("1LC51kMoKf1xxcgGD3Hrcdk6Ul8HaQH_L"),path="data/temp/Newfoundland_DietData.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Newfoundland_DietData.csv')
...
fwrite(Data, "data/diet/Newfoundland_Diet_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Newfoundland_DietData.csv")
