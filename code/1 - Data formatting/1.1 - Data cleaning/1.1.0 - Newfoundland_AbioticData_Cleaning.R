...
drive_download(as_id("1OD1J8YHQfhOmtxC-EAeTTrqWgTXT_DmL"),path="data/temp/All MS data NL fall95_spring_2018.12.03.csv",overwrite=TRUE)
drive_download(as_id("1Wg4fmlp-8FPhvKF_pidv-osSNXW_ek_V"),path="data/temp/Strata_info_2018.12.03.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/All MS data NL fall95_spring_2018.12.03.csv')
Strata<-fread('data/temp/Strata_info_2018.12.03.csv')
...
fwrite(Data, "data/abiotic/Newfoundland_Abiotic_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/All MS data NL fall95_spring_2018.12.03.csv")
file.remove("data/temp/Strata_info_2018.12.03.csv")
