...
drive_download(as_id("1G7ENMC13hcpGSVY9axWSQe9TYyHQP8E6"),path="data/temp/Gulf_Abiotic_Data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Gulf_Abiotic_Data.csv')
...
fwrite(Data, "data/abiotic/Gulf_Abiotic_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Gulf_Abiotic_Data.csv")
