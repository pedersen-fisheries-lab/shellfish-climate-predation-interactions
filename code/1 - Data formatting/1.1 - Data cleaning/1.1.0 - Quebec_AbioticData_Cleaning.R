...
drive_download(as_id("17ZzqTNijNK0kVUjfbs81W7t7klJSIHhd"),path="data/temp/QuebecRVRawData.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/QuebecRVRawData.csv')
...
fwrite(Data, "data/abiotic/Quebec_Abiotic_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/QuebecRVRawData.csv")
