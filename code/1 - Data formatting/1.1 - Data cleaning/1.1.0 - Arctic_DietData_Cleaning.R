...
drive_download(as_id("1KjS6tXu3oLSZj4BE9fu2Valb23Y2UkFw"),path="data/temp/Arctic_Diet_Data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Arctic_Diet_Data.csv')
...
fwrite(Data, "data/diet/Arctic_Diet_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Arctic_Diet_Data.csv")
