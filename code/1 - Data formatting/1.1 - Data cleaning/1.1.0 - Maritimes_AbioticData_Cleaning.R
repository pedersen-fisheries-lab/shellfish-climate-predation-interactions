...
drive_download(as_id("1MB6lwe-tIWAyVimh955-M9H-E4IcDtTF"),path="data/temp/MRAbiotic_Data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/MRAbiotic_Data.csv')
...
fwrite(Data, "data/abiotic/Maritimes_Abiotic_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/MRAbiotic_Data.csv")
