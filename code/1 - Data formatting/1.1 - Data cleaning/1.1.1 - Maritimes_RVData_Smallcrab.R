...
drive_download(as_id("1Ba0pZ1Ypop-g0z9qz8QoMcbBUki6wfSS"),path="data/temp/mar_smallcrab_data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/mar_smallcrab_data.csv')

# Load cleaned RV data
RV_Data<- fread("data/RV_survey/Maritimes_RV_Data_Cleaned.csv")
...
fwrite(Data, "data/RV_survey/Maritimes_RV_Data_Cleaned.csv")
