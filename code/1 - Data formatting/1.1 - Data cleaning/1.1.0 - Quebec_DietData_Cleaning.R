...
drive_download(as_id("1-ELs66SLh_Bd0_m_ubT-eJ6jSEZI6Rrx"),path="data/temp/Quebec_DietData.csv",overwrite=TRUE)
drive_download(as_id("15ELw2h2E7SaPHWO3aFKZaewju793cRad"),path="data/temp/Quebec_StrataInfo.csv",overwrite=TRUE)

# Load data
Data<-fread('data/temp/Quebec_DietData.csv')
Strata<-fread('data/temp/Quebec_StrataInfo.csv')
...
fwrite(Data, "data/diet/Quebec_Diet_Data_Cleaned.csv")

# Remove unnecessary temporary files
file.remove("data/temp/Quebec_DietData.csv")
file.remove("data/temp/Quebec_StrataInfo.csv")
