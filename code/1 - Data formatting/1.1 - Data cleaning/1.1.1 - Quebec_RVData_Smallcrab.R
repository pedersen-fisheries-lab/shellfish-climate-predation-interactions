...
drive_download(as_id("1sSSBPxNYfwR150c6tT9HppEJACWIBoHr"),path="data/temp/qc_smallcrab_data.csv",overwrite=TRUE)

# Load data
Data<-fread('data/RV_survey/qc_smallcrab_data.csv')

# Load cleaned RV data
RV_Data<- fread("data/temp/Quebec_RV_Data_Cleaned.csv")
...
fwrite(Data, "data/RV_survey/Quebec_RV_Data_Cleaned.csv")
