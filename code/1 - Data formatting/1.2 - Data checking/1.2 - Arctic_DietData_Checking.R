### ENSURE ARCTIC DIET DATA IS ERROR FREE ----
# Purpose: Ensure Arctic diet data is clean and error free
...
Data<- fread("data/temp/Arctic_Diet_Data_Cleaned.csv")
