...
ggsave("figures/Shrimp_projection_map.jpeg",plot=g,dpi=320, width = 14, height = 10, units = "in")
...
ggsave("figures/Crab_projection_map.jpeg",plot=g,dpi=320, width = 13, height = 7, units = "in")
