...
# Load dynamic data
Data_dynamic<-fread(file="data/temp/predicted_data.csv")
...
final_plot
ggsave("figures/Combined_projection_map_static_vs_dynamic.jpeg",plot=final_plot,dpi=320, width = 10, height = 14, units = "in")
