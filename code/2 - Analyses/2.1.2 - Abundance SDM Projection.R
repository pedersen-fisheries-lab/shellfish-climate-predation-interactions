...
Maritimes_Area <- readOGR('data/temp/shapefiles/Maritimes_area.shp')
Newfoundland_Area<-readOGR('data/temp/shapefiles/Newfoundland_area.shp')
Gulf_Area<-readOGR('data/temp/shapefiles/Gulf_area.shp')
Quebec_Area<-readOGR('data/temp/shapefiles/Quebec_area.shp')
Arctic_Area<-readOGR('data/temp/shapefiles/Arctic_area.shp')
...
fwrite(Predicted_Data, "data/temp/Projected_Spatial_Allregions.csv")
drive_upload("data/temp/Projected_Spatial_Allregions.csv",path=as_id("1WXZe13FgKee_f9Rg0dJC1q8ov928Jcd3",name="Projected_Spatial_Allregions"))

# Remove unnecessary temporary files
file.remove("data/temp/Projected_Spatial_Allregions.csv")
