...
fwrite(Data,file="data/temp/predicted_data.csv")
...
ggsave("figures/Shrimp_projection_map_2075.jpeg",plot=p,dpi=320, width = 14, height = 10, units = "in")
...
ggsave("figures/Crab_projection_map_2075.jpeg",plot=g,dpi=320, width = 13, height = 7, units = "in")

# Combine both plots into 1

final_plot<-ggarrange(p,g,labels=c("A","B"),ncol=1,nrow=2,widths=c(1,1),heights=c(1.25,1))
final_plot
ggsave("figures/Combined_projection_map_2075.jpeg",plot=final_plot,dpi=320, width = 13, height = 14, units = "in")
...
ggsave("figures/Predator_projection_map_2075.jpeg",plot=Plot_Predator,dpi=320, width = 10, height = 10, units = "in")
...
ggsave("figures/Diet_projection_map_baseline.jpeg",plot=Plot_Diet_baseline,dpi=320, width = 7, height = 7, units = "in")
...
ggsave("figures/Diet_projection_map_2075.jpeg",plot=Plot_Diet_2075,dpi=320, width = 7, height = 7, units = "in")
