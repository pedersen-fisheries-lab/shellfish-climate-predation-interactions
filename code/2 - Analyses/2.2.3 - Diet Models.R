...
# Load Data
drive_download(as_id("1zTb8gLpAxNHCRG87Op0Eibxz0xc6EpIn"),path="data/temp/Diet_Data_Allregions.csv",overwrite=TRUE)
Diet_Data<-fread('data/temp/Diet_Data_Allregions.csv')

drive_download(as_id("1WO3kQv6mMtxuyNPQ5L7J_IWFT5CaWRVY"),path="data/temp/Abiotic_Data_Allregions.csv",overwrite=TRUE)
Abiotic_Data<-fread('data/temp/Abiotic_Data_Allregions.csv')

drive_download(as_id("19C29ejKylQGDOAwZBGc5OgAzuS-lFv0Z"),path="data/temp/RV_Data_Allregions.csv",overwrite=TRUE)
RV_Data<-fread('data/temp/RV_Data_Allregions.csv')
...
fwrite(Diet_Data, "data/temp/Diet_Data_Projected.csv")
Diet_Data<-fread('data/temp/Diet_Data_Projected.csv')
