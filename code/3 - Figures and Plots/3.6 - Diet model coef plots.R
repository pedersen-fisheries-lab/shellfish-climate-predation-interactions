...
ggsave("figures/plot_diet_temp.jpeg",plot=Plot_Temp,dpi=450, width = 7.5, height = 4.5, units = "in")
ggsave("figures/plot_diet_prey.jpeg",plot=Plot_Prey,dpi=450, width = 7.5, height = 4.5, units = "in")
ggsave("figures/plot_diet_plank.jpeg",plot=Plot_Plank,dpi=450, width = 7.5, height = 4.5, units = "in")
