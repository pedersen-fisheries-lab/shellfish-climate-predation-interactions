...
ggsave("figures/plot_temp_depth_shrimp.jpeg",plot=Plot_Temp_Depth_Shrimp,dpi=450, width = 6.5, height = 3.25, units = "in")
ggsave("figures/plot_temp_depth_crab.jpeg",plot=Plot_Temp_Depth_Crab,dpi=450, width = 6.5, height = 5.5, units = "in")
...
ggsave("figures/Shrimp_Predators.jpeg",plot=g,dpi=320, width = 7.5, height = 7.5, units = "in")
...
ggsave("figures/Crab_Predators.jpeg",plot=g,dpi=320, width = 6.5, height = 5.5, units = "in")
